...
class ChooseCities extends StatefulWidget {
  ...
  ChooseCities({this.isChooseMapScreen = false, this.isSettingScreen = false});
        ...
        bottomNavigationBar: SafeArea(
          child: Padding(
            ...
            child: PrimaryElevatedBtn(
                buttonText: language.choose_city_confirm,
                onPressed: () async {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // _sizedBox(),
                Text(language.choose_city_title,
                    style: textTheme.bodyText1!
                        .copyWith(fontSize: 15.sp, color: AppThemes.dark)),
                SizedBox(
                  height: 4.0,
                ),
                Text(language.choose_city_desc,
