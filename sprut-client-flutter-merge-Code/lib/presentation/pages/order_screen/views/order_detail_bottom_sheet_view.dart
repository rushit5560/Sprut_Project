  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Obx(() {
            return SizedBox(height: controller.isExpanded.isTrue ? 32 : 8);
          }),
          SizedBox(
            height: 5,
            width: 50,
          ...
          if (controller.isMapView == false &&
            ...
            Text(
              controller.orderInfoDetails.value?.createdAt == null
                  ? ""
                  : "${language.order_date} ${Helpers.orderCreatedDate(
                  context, controller.orderInfoDetails.value?.createdAt,language.today_at)}",
                    ...
                    if (controller.orderInfoDetails.value != null) ...[
                      Container(
                        ...
                        child: Column(
                          children: [
                            Text(
                              controller.orderInfoDetails.value?.car != null
                                  ? '${Helpers.getOrderStatusByDeliveryStatus(
                                  context, '${controller.orderInfoDetails.value?.status}', language)}'
                                  : "${Helpers.getOrderStatusByDeliveryStatus(
                                  context, controller.orderInfoDetails.value
                                  ?.deliveryStatus, language)}",
                              style: textTheme.bodyText1!.copyWith(
                                fontSize: 16.sp,
                                color: Colors.white,
                              ),
                            ...
                            SizedBox(height: 4),
                            Text(
                              "${Helpers.getTimeDelivery(context,
                                  controller.orderInfoDetails.value?.createdAt,
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                Helpers.launchUrl(
                                    "tel:${controller.orderInfoDetails.value
                                        ?.car?.driverPhoneNumber}");
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Spacer(),
                              Text(
                                "${controller.orderInfoDetails.value?.products
                                    ?.length} ${language.items}",
                                style: textTheme.bodySmall!.copyWith(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Spacer(),
                              Text(
                                "${controller.getCartItemTotalAmount(
                                    controller.orderInfoDetails.value
                                        ?.products)} ${language
                                    .currency_symbol}",
                                style: textTheme.bodySmall!.copyWith(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "${language.cashback} ${controller
                                            .orderInfoDetails.value!
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "${controller.orderInfoDetails.value
                                    ?.establishment?.calculatedPrice} ${language
                                    .currency_symbol}",
                                style: textTheme.bodySmall!.copyWith(
                                    fontSize: 12.sp, color: Colors.white),
                                textAlign: TextAlign.end,
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                // Spacer(),
                                Text(
                                  "${controller.freeShippingAmount()} ${language
                                      .currency_symbol}",
                                  style: textTheme.bodySmall!.copyWith(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                "${controller.orderInfoDetails.value
                                    ?.products![index].quantity}x ${controller
                                    .orderInfoDetails.value?.products![index]
                                    .productData?.name}",
                                style: textTheme.bodySmall!.copyWith(
                            ...
                            Spacer(),
                            Text(
                              "${controller.getItemPriceWith2Digit(
                                  "${controller.orderInfoDetails.value
                                      ?.products![index].price}")} ${language
                                  .currency_symbol}",
                              style: textTheme.bodySmall!.copyWith(
